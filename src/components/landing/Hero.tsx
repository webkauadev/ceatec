...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-foreground">
      ...
      <div className="container-wide relative z-10 py-16 md:py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-xl">
            {/* Social proof badge */}
            <div className="inline-flex items-center gap-2 bg-primary/20 backdrop-blur-sm border border-primary/30 rounded-full px-4 py-1.5 mb-6 animate-slide-up">
            ...
            {/* Turmas */}
            <div className="bg-white/10 backdrop-blur-sm rounded-xl border border-white/15 p-5 mb-8 animate-slide-up" style={{ animationDelay: '0.15s' }}>
              <div className="flex items-center gap-2 mb-3">
                <CalendarDays className="w-4 h-4 text-primary" />
                <span className="text-white font-semibold text-sm tracking-wide uppercase">Próximas turmas presenciais</span>
              </div>
              <div className="space-y-1.5 text-white/85 text-sm">
                <p><span className="font-bold">Vilhena:</span> 24, 25 e 26 de abril</p>
                <p><span className="font-bold">Jataí:</span> 01, 02 e 03 de maio</p>
              </div>
            </div>
            ...
            <div className="animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <Button
                ...
                size="lg"
                className="btn-primary gap-2 text-base h-14 px-10"
              >
            ...
            <div className="flex items-center gap-4 mt-6 animate-slide-up" style={{ animationDelay: '0.25s' }}>
              <span className="text-xs text-white/50">+200 pilotos formados</span>
              <span className="w-1 h-1 rounded-full bg-white/30" />
              <span className="text-xs text-white/50">Reconhecido pelo MAPA</span>
            </div>
          </div>

          {/* Right — spacer to let image breathe on desktop */}
